...
class _SingleArticleState extends State<SingleArticle>
    with SingleTickerProviderStateMixin {
  late Animation<double> opacityContainer;
  late Animation<Offset> translateDownContainer;
  late Animation<Offset> translateUpText;
  ...
  void initState() {
    ...
    translateDownContainer = Tween<Offset>(
      begin: Offset(0.0, 20),
      end: Offset.zero,
    ).animate(CurvedAnimation(
      parent: animationController,
        ...
        children: <Widget>[
          ...
          Positioned(
            ...
            child: SlideTransition(
              position: translateDownContainer,
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            Text(
                              widget.title.toUpperCase(),
                              style: TextStyle(fontFamily: "Butler", fontSize: 40),
                            ),
                            SizedBox(height: 20),
                            SlideTransition(
                              position: translateUpText,
                              child: FadeTransition(
                                opacity: opacityText,
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
